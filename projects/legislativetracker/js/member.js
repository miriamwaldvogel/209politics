var para = {'flora': {'status': {'Introduced': [0]}, 'role': {'sponsor': [], 'cosponsor': [0]}, 'type': {'Bill': [0]}, 'date': ['12/10/2020'], 'area': {'COVID-19': [0]}}, 'cooper': {'status': {'Introduced': [0, 1, 2, 3, 4]}, 'role': {'sponsor': [0, 1, 2, 3], 'cosponsor': [4]}, 'type': {'Bill': [0, 1, 2, 3, 4]}, 'date': ['12/16/2020', '12/7/2020', '12/7/2020', '12/7/2020', '12/7/2020'], 'area': {'Cannabis': [0], 'Housing': [4], 'Peace officers': [2], 'Bail': [3], 'State bodies': [1]}}, 'harder': {'status': {'Introduced': [0]}, 'role': {'sponsor': [], 'cosponsor': [0]}, 'type': {'Resolution': [0]}, 'date': ['1/11/2021'], 'area': {'Congress': [0]}}, 'villapudua': {'status': {'Introduced': [0]}, 'role': {'sponsor': [0], 'cosponsor': []}, 'type': {'Bill': [0]}, 'date': ['1/11/2021'], 'area': {'Taxation': [0]}}, 'mcnerney': {'status': {'Introduced': [0, 1, 2, 3, 4, 5]}, 'role': {'sponsor': [], 'cosponsor': [0, 1, 2, 3, 4, 5]}, 'type': {'Bill': [0, 1, 4], 'Resolution': [2, 3, 5]}, 'date': ['1/4/21', '1/4/21', '1/4/21', '1/11/21', '1/11/21', '1/11/21'], 'area': {'Government operations and politics': [2, 3], 'Not assigned': [0, 1, 4], 'Congress': [5]}}, 'eggman': {'status': {'Introduced': [0, 1, 2]}, 'role': {'sponsor': [], 'cosponsor': [0, 1, 2]}, 'type': {'Bill': [0, 1, 2]}, 'date': ['12/16/2020', '12/7/2020', '12/7/2020'], 'area': {'Communications': [0], 'Housing': [2], 'Drugs/alcohol': [1]}}};
