import csv
f = open('/home/miriamwaldvogel/209politics/projects/911calls/data/stockton.csv', 'r')
r = csv.reader(f)
next(r)
s = ''
for i in r:
...
f = open('/home/miriamwaldvogel/209politics/projects/911calls/stockton.html', 'r')
g = f.read().split(l, 1)
f.close()
f = open('/home/miriamwaldvogel/209politics/projects/911calls/stockton.html', 'w')
f.write(g[0]+l+"\n"+s+g[1].split("var map", 1)[1]+"var map")
f.close()
