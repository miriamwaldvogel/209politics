...
filter = []
types = {
"Vehicle/traffic": ["Traffic fatality", "Stolen vehicle arrest", "Vehicle pursuit arrest", "Traffic pursuit", "Pursuit arrest", "Carjacking", "Hit and run", "Vehicle pursuit", "Traffic injury", "Auto theft arrest", "Carjacking arrest", "Hit and run fatality", "DUI arrest", "Hit and run fatality", "Attempted auto burglary", "Major injury collision", "Attempted carjacking"],
"Homicide": ["Homicide"],
"Theft/robbery": ["Robbery", "Attempted robbery", "Strong-arm robbery", "Armed robbery", "Auto burglaries", "Robbery arrest"],
"Residential": ["Residential robbery", "Home invasion", "Burglary", "Home invasion robbery", "Burglary arrest", "Attempted armed robbery"],
...
"Shooting/weapons": ["Shooting into a dwelling", "Person shot", "Weapon arrest", "Shooting into a vehicle", "Shooting into a building", "People shot", "Negligent discharge of a firearm", "Negligent discharge", "Residence struck by gunfire", "Vehicle struck by gunfire", "Shooting into dwellings", "Brandishing", "Shooting into an unoccupied building", "Shooting into unoccupied vehicles", "Shooting into an occupied dwelling", "Shooting into an unoccupied vehicle"],
"Officer shooting": ["Officer shooting"],
"Kidnapping": ["Kidnapping", "Kidnapping arrest", "Attempted kidnapping"],
"Mental health call": ["Mental health call"],
"Other": ["Attempted murder arrest", "Attempted murder", "Suspicious package", "Laser strike arrest", "Criminal threats arrest", "Explosive materials arrest", "Warrant service", "Attempted homicide arrest", "Terrorist threats", "Attempted homicide", "Homicide arrest", "Death investigation", "Device found", "Medical assistance", "Criminal threats"],
