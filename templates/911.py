...
filter = []
types = {
"Vehicle/traffic": ["Traffic fatality", "Stolen vehicle arrest", "Vehicle pursuit arrest", "Traffic pursuit", "Pursuit arrest", "Carjacking", "Hit and run", "Vehicle pursuit", "Traffic injury", "Auto theft arrest", "Carjacking arrest"],
"Homicide": ["Homicide"],
...
"Fire": ["Arson", "Arson arrest", "Warehouse fire"],
...
"Other": ["Attempted murder arrest", "Attempted murder", "Suspicious package", "Laser strike arrest", "Criminal threats arrest", "Explosive materials arrest", "Warrant service", "Attempted homicide arrest", "Terrorist threats", "Attempted homicide"],
