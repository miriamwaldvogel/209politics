...
def article():
    ...
    if newimg.get():
        ...
        card = ("%s/%s/%s/%s") % (d[0], d[1], d[3], imgname.get())
        s = """<div id="%scontainer" class="storycontainer bigstory">
          <a href="/%s/%s/%s/%s.html" class="storylink">
            <div class="storyimgcontainer %s">
              <img src="/%s/%s/%s/%s" alt="%s" class="storyimg">
            </div>
            <div class="storytextcontainer %s">
              <p class="mainstory headline storyheadline">%s</p>
              <p class="articledate">%s %d, %s</p>
            </div>
          </a>
        </div>
        <!---->
"""%(pageid.get(), d[0], d[1], d[3], htmlname.get(), size[0], d[0], d[1], d[3], imgname.get(), newalt.get(), size[1], headline, d[2], int(d[3]), d[0])
        ...
        <div id="mainstorycontainer" class="mainstory">
          <a href="%s/%s/%s/%s.html" id="mainstorylink" class="mainstory">
            ...
            <h1 id="mainstoryheadline" class="mainstory headline">%s</h1>
        ...
        s = """<div id="%scontainer" class="storycontainer bigstory">
          <a href="/%s/%s/%s/%s.html" class="storylink">
            <div class="storyimgcontainer %s">
              <img src="%s" alt="%s" class="storyimg">
            </div>
            <div class="storytextcontainer %s">
              <p class="mainstory headline storyheadline">%s</p>
              <p class="articledate">%s %d, %s</p>
...
""" % (d[0], d[1], d[3], htmlname.get(), path.get() , oldalt.get(), headline, d[2], int(d[3]), d[0])
    ...
    <head>
      ...
      <meta property="og:image" content="https://209politics.com/%s">
      <meta property="og:type" content="article"/>
      <meta name="twitter:card" content="summary">
      <meta name="twitter:site" content="@209politics">
      <meta name="twitter:title" content="%s">
      <meta name="twitter:image" content="https://209politics.com/%s">
      ...
      <script>
        ...
        gtag('js', new Date()); gtag('config', 'UA-174685284-1');
      </script>
      <title>%s - 209 Politics</title>
    </head>
    <body>
      <div id="content">
        <div id="headercontainer">
          ...
          <div id="searchcontainer">
            <div id="searchimgcontainer" onclick="searchtoggle();"> <img src="/images/search.svg" alt="Search sybmol" id="searchimg"> </div>
            <div id="formcontainer1">
              <form id="searchform" action="https://www.google.com/search" method="get">
                ...
                <input type="submit" value="GO" class="searchbutton" id="searchbutton1"> </form>
            </div>
          </div>
        </div>
        <div id="sectionscontainer" class="sections">
          ...
          <div id="latestnavcontainer" class="headernavcontainer"> <a href="/latest" id="latest" class="section">LATEST</a> </div>
          <div id="electionsnavcontainer" class="headernavcontainer"> <a href="/elections" id="elections" class="section">ELECTIONS</a> </div>
          <div id="policynavcontainer" class="headernavcontainer"> <a href="/policy" class="section">POLICY</a> </div>
          <div id="intnavcontainer" class="headernavcontainer"> <a href="/covid-19" class="section">COVID-19</a> </div>
          <div id="contactnavcontainer" class="headernavcontainer"> <a href="/interactives" class="section">INTERACTIVES</a> </div>
        </div>
...
"""%(card, headline, card, headline, headline, d[2], int(d[3]), d[0], d[4]))
    if artimg.get():
        f.write("""<div id="img1container" class="%simg"><img src="%s" alt="%s" id="img1">
          ...
          <p id="img1credit" class="credit">%s</p>
        </div>
""" % (imgalign.get(), imgname.get(), newalt.get(), caption.get(), credit.get()))
    ...
    <div id="footer">
      <p id="socialmediafooter"> <a href="https://twitter.com/209Politics" id="twitterfooter" class="sociallinkfooter">Twitter: @209politics</a> • <a href="https://www.instagram.com/209.politics/" id="instagramfooter" class="sociallinkfooter">Instagram: @209.politics</a> • <a href="https://www.facebook.com/209Politics"
        id="facebookfooter" class="sociallinkfooter">Facebook: @209Politics</a> </p>
      <p id="navfooter"> <a href="/index" id="homenavfooter" class="navfooter">Home</a> • <a href="/latest" id="latestnavfooter" class="navfooter">Latest</a> • <a href="/elections" id="electionsnavfooter" class="navfooter">Elections</a> • <a href="/policy" id="policynavfooter"
        class="navfooter">Policy</a> • <a href="/covid-19" id="covidnavfooter" class="navfooter">COVID-19</a> • <a href="/interactives" class="navfooter">Interactives</a> • <a href="/contact" id="contactnavfooter" class="navfooter">Contact us</a> </p>
    </div>
    </body>
